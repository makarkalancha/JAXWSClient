 ...
 * generated in the org.mycompany.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://webservice.mycompany.org/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://webservice.mycompany.org/", "helloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.mycompany.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.mycompany.org/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.mycompany.org/", name = "helloWorldResponse")
